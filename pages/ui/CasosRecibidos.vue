...
<template>
  <div class="jumbotron">
    <h1 class="display-4">Casos Recibidos</h1>
    <p class="lead">
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <a class="btn btn-danger btn-xs" href="/ui/detallecaso" role="button">Ver</a>
            </td>
          </tr>
          <tr>
            <th scope="row">2</th>
            ...
            <td>07-ago-23 15:45</td>
            <td>
              <a class="btn btn-danger btn-xs" href="#" role="button">Ver</a>
            </td>
          </tr>
          <tr>
            <th scope="row">2</th>
